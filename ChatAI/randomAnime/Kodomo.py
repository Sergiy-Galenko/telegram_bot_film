...
genre_id = 11111  # ID для жанра Kodomo
anime_keyword_id = 210024  # ID для ключевого слова "аниме"
page = random.randint(1, 500)  # Выбираем случайную страницу от 1 до 500

discover_url = f'{base_url}/discover/tv?api_key={api_key}&with_genres={genre_id}&with_keywords={anime_keyword_id}&page={page}'
...
if response.status_code == 200:
    ...
    if data['results']:
        ...
        if tv_show_response.status_code == 200:
            ...
            print(f"Рандомный аниме-сериал из жанра Kodomo: {show_title}\n"
