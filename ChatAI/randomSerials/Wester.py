...
def get_random_western_series(api_key):
    url = f"https://api.themoviedb.org/3/discover/tv?api_key={api_key}&with_genres=37"
...
series = get_random_western_series(api_key)
if series:
