...
class RandomWesternSeries:
    ...
    def get_random_western_series(self):
        url = f"https://api.themoviedb.org/3/discover/tv?api_key={self.api_key}&with_genres=37"
...
random_western_series = RandomWesternSeries(api_key)
series = random_western_series.get_random_western_series()
if series:
