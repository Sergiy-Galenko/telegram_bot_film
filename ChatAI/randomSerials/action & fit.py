...
def get_random_action_adventure_series(api_key):
    url = f"https://api.themoviedb.org/3/discover/tv?api_key={api_key}&with_genres=10759"
...
series = get_random_action_adventure_series(api_key)
if series:
