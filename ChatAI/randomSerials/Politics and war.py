...
class RandomWarSeries:
    ...
    def get_random_war_series(self):
        url = f"https://api.themoviedb.org/3/discover/tv?api_key={self.api_key}&with_genres=10768"
...
random_war_series = RandomWarSeries(api_key)
series = random_war_series.get_random_war_series()
if series:
