...
class RandomSoapSeries:
    ...
    def get_random_soap_series(self):
        url = f"https://api.themoviedb.org/3/discover/tv?api_key={self.api_key}&with_genres=10766"
...
random_soap_series = RandomSoapSeries(api_key)
series = random_soap_series.get_random_soap_series()
if series:
