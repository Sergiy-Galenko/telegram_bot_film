...
def get_random_family_series(api_key):
    url = f"https://api.themoviedb.org/3/discover/tv?api_key={api_key}&with_genres=10751"
...
series = get_random_family_series(api_key)
if series:
