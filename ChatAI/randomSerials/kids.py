...
class RandomKidsSeries:
    ...
    def get_random_kids_series(self):
        url = f"https://api.themoviedb.org/3/discover/tv?api_key={self.api_key}&with_genres=10762"
...
random_kids_series = RandomKidsSeries(api_key)
series = random_kids_series.get_random_kids_series()
if series:
